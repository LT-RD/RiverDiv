...
// Création de la mini-carte (Overview Map)
var overviewMapControl = new ol.control.OverviewMap({
    collapsed: false, // La mini-carte est affichée par défaut
    layers: [
        new ol.layer.Tile({
            source: new ol.source.OSM() // Utilise OpenStreetMap comme fond de mini-carte
        })
    ]
});

// Ajouter la mini-carte à la carte principale
...
// Ajouter la couche de dessin à la carte
map.addLayer(drawLayer);

// Activer le mode dessin (par défaut en mode polygone)
...
map.getView().fit([849029.553493, 6260503.150380, 911636.751660, 6325463.602682], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">RiverDiv : Atlas macro-invertébrés</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (298 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Dans le cadre du projet INTERREG RIVERDIV, des travaux comprenant des campagnes de terrain vise à étudier les zones refuges et les macro-invertébrés. Suite à un travail d\'identification, l\'atlas suivant a été produit pour permettre de visualiser les différents ordres présents et leurs proportions.';
            }
